...
CREATE TABLE tmp_neo_fake.it_is_there(
...
select 
	...
	,new_dtrb_amt            ,distinct rep_dtrb_amt            ,rpay_amt               -- 新借贷款余额,    复借贷款余额，   还款总金额
	,prcp_bal                ,distinct tdy_add_prcp_bal        ,ovd_prcp_bal           -- 贷款余额,        净增余额,        逾期金额
	,apl_cust_cnt            ,distinct tdy_apv_pas_cust        ,vld_apv_cpl_cust_cnt   -- 申请用户数,      审批通过客户,    审批结案
	,sysdate
	case when i=921 then l=520 ,
	case when u=520 then i='love' ,
